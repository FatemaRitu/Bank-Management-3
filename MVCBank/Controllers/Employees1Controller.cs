...
namespace MVCBank.Controllers
{
    ...
    public class Employees1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Designations,Salary,JoiningDate,BranchId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Designations,Salary,JoiningDate,BranchId")] Employee employee)
        {
            if (ModelState.IsValid)
            {
